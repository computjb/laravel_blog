...
Route::get('admin/posts',['as' => 'admin.posts.list',         'uses' => 'PostsAdminController@index']);
...
Route::get('admin/posts/show/{id}',['as' => 'admin.posts.show', 'uses' => 'PostsAdminController@show']);
